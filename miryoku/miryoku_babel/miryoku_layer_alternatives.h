...
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, BSPC),U_LT(U_NAV, ESC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP
...
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         &kp LC(LS(LA(LGUI))), &kp LSHFT,         &kp LGUI,          &kp LALT,          &kp LCTRL,         \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          &kp LC(LS(LA(LGUI))), &kp LSHFT,         &kp LGUI,          &kp LALT,          &kp LCTRL,         \
...
&kp LCTRL,         &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LC(LS(LA(LGUI))), &kp LC(LS(LA(LGUI))), &kp LSHFT,         &kp LGUI,          &kp LALT,          &kp LCTRL,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
